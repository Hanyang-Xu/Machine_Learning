...
class MultilayerPerceptron():
    ...
    class layer:
        def __init__(self, input_num, cell_num, activation=None):
            self.W = np.random.randn(cell_num, input_num + 1)*0.5
...
if __name__ == '__main__':
    ...
    MLP.build_layer(13, 8, 'sigmoid')
    MLP.build_layer(8, 4, 'sigmoid')
    MLP.build_layer(4, 2, 'sigmoid')
    MLP.build_layer(2, 1, 'sigmoid')
